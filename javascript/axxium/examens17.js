      	  				...
      	  				if (qEXA[extIDexa].qType.substring(0,1) == "M" || qEXA[extIDexa].qType.substring(0,1) == "N")
      	  					{
    	  						...
    	  						div = document.createElement("tr");
      	  						...
      	  						if (forceMustSeeExa || aMust == "Y" || ctrM > 0)
      	  						{
      	  							...
      	  							aLine = aLine + '<td><b>'+chk+'</b></td><td id="m'+extIDexa+'" class="warning">'+qEXA[extIDexa].qEdits+'</td><td><h4><div class="ui axxium tiny button" onclick="addNotes2(\''+extIDexa+'\');">Ajouter</div></h4></td>';
      	  							div.innerHTML = aLine;
    	  							document.getElementById("eachExa").appendChild(div);
      	  						}
      	  					}
      	  				...
      	  				else if (qEXA[extIDexa].qType == "TX")
      	  					{
      	  						...
      	  						if (forceMustSeeExa || aMust == "Y" || ctrT > 0)
      	  						{
    	  							div = document.createElement("tr");
      	  							aLine = '<td>'+extIDexa+'</td><td>'+allEXAMs[extIDexa].question[lang]+'</td>';
      	  							aLine = aLine + '<td><b>'+qEXA[extIDexa].answers[0].text+'</b></td><td id="m'+extIDexa+'" class="warning">'+qEXA[extIDexa].qEdits+'</td><td><h4><div class="ui axxium tiny button" onclick="addNotes2(\''+extIDexa+'\');">Ajouter</div></h4></td>';
      	  							div.innerHTML = aLine;
    	  							document.getElementById("eachExa").appendChild(div);
      	  						}
      	  					}
      	  				else
      	  					{
    	  						div = document.createElement("tr");
      	  						aLine = '<td>'+extIDexa+'</td><td>'+allEXAMs[extIDexa].question[lang]+'</td>';
      	  						aLine = aLine + '<td></td><td id="m'+extIDexa+'" class="warning">'+qEXA[extIDexa].qEdits+'</td><td><h4><div class="ui axxium tiny button" onclick="addNotes2(\''+extIDexa+'\');">Ajouter</div></h4></td>';
      	  						div.innerHTML = aLine;
    	  						document.getElementById("eachExa").appendChild(div);
      	  					}
  }
