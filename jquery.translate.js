...
"Prix " : { en: "  " },
"Rendez-vous " : { en: "  " },
"Supprimer les traitements n              Total du plan de traitement : " : { en: "  " },
"Supprimer les traitements " : { en: "  " },
"Versement " : { en: "  " },
"Montant " : { en: "  " },
"Note " : { en: "  " },
"Supprimer les versements n            Ajouter un versement n              Total de l'entente : " : { en: "  " },
...
"Supprimer les traitements n            Ajouter un ou des traitements " : { en: "  " },
"Ajouter un ou des traitements " : { en: "  " },
"Médicament " : { en: "  " },
"Dose " : { en: "  " },
"Qté " : { en: "  " },
"Fréq " : { en: "  " },
"Supprimer les médicaments n            Ajouter un médicament " : { en: "  " },
...
"Acte posé plus souvent que convenu à l entente (1727) " : { en: "  " },
"Chirurgie secondaire pratiquée au cours d une même séance qu une chirurgie principale (38) " : { en: "  " },
"Examen ou soin post-opératoire qui n est pas en lien avec la chirurgie (1728) " : { en: "  " },
"Mise en place de la première plaque de reconstruction (37) " : { en: "  " },
"Nouvelle intervention qui est reliée à la première ou en résulte lors d une même hospitalisation (1752) " : { en: "  " },
"Nouvelle intervention qui n est pas reliée à la première ou n en résulte pas lors d une même hospitalisation (39) " : { en: "  " },
"Patient sous anesthésie générale (1724) " : { en: "  " },
"Remplacement d une prothèse pour perte ou bris (41) " : { en: "  " },
"Remplacement de deux prothèses pour perte ou bris (1723) " : { en: "  " },
"Séance différente (1746) " : { en: "  " },
"Service dont la complexité est inhabituelle (34) " : { en: "  " },
"Service fourni en centre hospitalier avec le concours d'un ou de dentistes résidents dans un programme visé (1742) " : { en: "  " },
"Site différent (1749) " : { en: "  " },
"Soin pré-opératoire qui n est pas en lien avec la chirurgie (1726) " : { en: "  " },
"Soins d urgence (1725) " : { en: "  " },
"Soins post-opératoire confiés à un autre dentiste (35) " : { en: "  " },
"Soins post-opératoire confiés par un autre dentiste (36) " : { en: "  " },
"Suite à un traumatisme (1744) " : { en: "  " },
"Suite à une malformation osseuse (1729) " : { en: "  " },
