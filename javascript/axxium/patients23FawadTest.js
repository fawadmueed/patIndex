  ...
  function displaySub(aTab)
  {
  	//alert(aTab);
        ...
        if (aTab == "patient")
        {
        	...
        	document.getElementById("updateAvail").innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick=";" style="margin:5px">Dossier Patient</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick=";">Facturation</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick=";">Plan de traitement</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick=";">Paiements</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick=";">Historique</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick=";">Financier</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick=";">Rappel</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="modCreateDos();">Creer un dossier</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="modCreateDos();">Creation rapide</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick=";">Modifier</div><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="modResponsable();" style="margin:5px">Responsable</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="modFamille();">Famille</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="modReference();">Reference</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="dosConsul();">Dossier consultes ...</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="modEnregistrer();">Enregistrer</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="modImpression();">Impression</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="modAlert();">Alerte médicale</div>&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="modSuivi();">Suivi médical</div>&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="modLabo();">Laboratoires</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="modAlertNew();">Alerte</div>';
        }
