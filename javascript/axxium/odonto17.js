  ...
  function drawRest(ctx,aColor1,aColor2,aList)
  {
      		for (cd in aList)
      		{
    	  		if (aList[cd]["tooth"] && aList[cd].code == "23111" || aList[cd]["tooth"] && aList[cd].code == "23112" || aList[cd]["tooth"] && aList[cd].code == "23113")
    	  			{
	...
	ctx.lineWidth=3;
      	...
      	for (cd in aList)
      	{
    	  	if (aList[cd]["tooth"] && ((showAdult && aList[cd]["tooth"] < 50) || (!showAdult && aList[cd]["tooth"] > 50)))
    	  	{
				...
				{
					ctx.beginPath();
					ctx.ellipse((pos.x+(pos.dx/2))*odoX,(pos.y+(pos.dy-20))*odoY,(pos.dx/4)*odoX,6*odoY, 0, 2.5, 7);
					ctx.stroke();
					ctx.closePath();
				}
				else
				{
					ctx.beginPath();
					ctx.ellipse((pos.x+(pos.dx/2))*odoX,(pos.y+20)*odoY,(pos.dx/4)*odoX,6*odoY, 0, 2.5, 7);
					ctx.stroke();
					ctx.closePath();
				}
				...
				{
					ctx.beginPath();
					ctx.moveTo((pos.x+(pos.dx/2)-13)*odoX,(pos.y+(pos.dy-22))*odoY);
					ctx.lineTo((pos.x+(pos.dx/2)-8)*odoX,(pos.y+(pos.dy-16))*odoY);
					ctx.lineTo((pos.x+(pos.dx/2)-3)*odoX,(pos.y+(pos.dy-22))*odoY);
					ctx.stroke();
					ctx.closePath();
				}
				else
	...
	ctx.lineWidth=3;
      	...
      	for (cd in aList)
      	{
    	  	if (aList[cd]["tooth"] && ((showAdult && aList[cd]["tooth"] < 50) || (!showAdult && aList[cd]["tooth"] > 50)))
    	  	{
				...
				{
					ctx.beginPath();
					ctx.ellipse((pos.x+(pos.dx/2))*odoX,(pos.y+(pos.dy-20))*odoY,(pos.dx/4)*odoX,6*odoY, 0, -0.5, 3.5);
					ctx.stroke();
					ctx.closePath();
				}
				else
				{
					ctx.beginPath();
					ctx.ellipse((pos.x+(pos.dx/2))*odoX,(pos.y+20)*odoY,(pos.dx/4)*odoX,6*odoY, 0, -0.5, 3.5);
					ctx.stroke();
					ctx.closePath();
				}
				...
				{
					ctx.beginPath();
					ctx.moveTo((pos.x+(pos.dx/2)-14)*odoX,(pos.y+23)*odoY);
					ctx.lineTo((pos.x+(pos.dx/2)-9)*odoX,(pos.y+17)*odoY);
					ctx.lineTo((pos.x+(pos.dx/2)-4)*odoX,(pos.y+23)*odoY);
					ctx.stroke();
					ctx.closePath();
				}
				else
  ...
  function drawCar(ctx,aColor,aList)
  {
	...
	ctx.lineWidth=4;
      	...
      	for (cd in aList)
      	{
    	  	...
    	  	if (aList[cd]["tooth"] && (aList[cd].code.substr(0,4) == "2122" || aList[cd].code.substr(0,4) == "2322"))
    	  		{
    	  			surf = aList[cd]["surface"];
    	  			for (var i = 0, len = surf.length; i < len; i++)
    	  			{
  ...
  function acceptSeloEB()
  {
  	...
  	{	
  		...
  		odonto.exist.push({ "code" : aCode, "tooth" : aToothO, "surface" : textS, "note" : "" });
    						}
    					}
    					ctrp = ctrp + 1;
    				}
  ...
  function acceptSeloAF()
  {
  	...
  	{	
    		...
    		var aCode = qSelo[qKeys[key]]["rows"][rr][cc].desc.substring(0,5);
    		//alert("code "+aCode+" tooth "+aToothO+" surface "+textS);
  		odonto.todo.push({ "code" : aCode, "tooth" : aToothO, "surface" : textS, "note" : "" });
    						}
    					}
    					ctrp = ctrp + 1;
    				}
  ...
  function acceptSeloAS()
  {
  	...
  	{	
    		...
    		var aCode = qSelo[qKeys[key]]["rows"][rr][cc].desc.substring(0,5);
    		//alert("code "+aCode+" tooth "+aToothO+" surface "+textS);
  		odonto.observ.push({ "code" : aCode, "tooth" : aToothO, "surface" : textS, "note" : "" });
    						}
    					}
    					ctrp = ctrp + 1;
    				}
