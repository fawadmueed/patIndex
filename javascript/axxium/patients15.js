  ...
  function getAxxium()
  {
  	...
  	{
  	    $.get("http://localhost/PatientService/PatientInfo.asmx/getPatient?id="+axxNumber, function(data, status){
	        //alert("Data: " + data + "\nStatus: " + status);
  ...
  function displayPatient(aPat)
  {
  	...
  	suiviMed = "";
  	if (qPAT.patients[cPat].suivi) suiviMed = qPAT.patients[cPat].suivi;
  	...
  	document.getElementById("Esuivi").value = suiviMed;
  	//Centre dentaire Sirois<br>100001 - Claude Arsenault, 1946-07-12&nbsp;&nbsp;&nbsp;&nbsp;
  	var topPat = 'JS&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="reOpenSearch();">Changer de patient</div>&nbsp;&nbsp;&nbsp;'+aPat+' - '+curName+', '+birth+'&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="window.print();">Imprimer</div>';
  ...
  function displaySub(aTab)
  {
  	//alert(aTab);
        ...
        if (aTab == "patient")
        {
        	...
        	document.getElementById("updateAvail").innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="modAlert();">Alerte médicale</div>&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="modSuivi();">Suivi médical</div>';
        }
        ...
        if (aTab == "odontos")
        {
        	...
        	if (qODONS.files.length > 0)
        	{
        		...
        		omen = omen + '</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="getSign(0,\'ODO\');"><i class="write icon"></i> patient</div>&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="getSign(1,\'ODO\');"><i class="write icon"></i> dentiste</div>';
