  ...
  function fullLoadPatient()
  {
          ...
          $('.menu .item').tab({'onVisible':function(aTab){updateAvail(aTab)}});
          $('.menu .item').tab('change tab', 'patient');
  }
  ...
  function getAxxium()
  {
  	...
  	{
  	    $.get("http://192.168.240.10/PatientService/PatientInfo.asmx/getPatient?id="+axxNumber, function(data, status){
	        //alert("Data: " + data + "\nStatus: " + status);
  ...
  xmlhttp2.open("GET","allScriptsv1.py?tx=getPHOv1&patID="+aPat,true);
  xmlhttp2.send();
  ...
  function displayPatient(aPat)
  {
  	...
  	medLabo = "";
  	if (qPAT.patients[cPat].labo) 
  	{
  		medLabo = qPAT.patients[cPat].labo;
  		if (qPAT.patients[cPat].laboD) medLabo = qPAT.patients[cPat].laboD + " " + medLabo;
  	}
  	...
  	document.getElementById("Elabo").value = medLabo;
  	//Centre dentaire Sirois<br>100001 - Claude Arsenault, 1946-07-12&nbsp;&nbsp;&nbsp;&nbsp;
  	var topPat = curInitials+'&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="reOpenSearch();">Changer de patient</div>&nbsp;&nbsp;&nbsp;'+aPat+' - '+curName+', '+birth+'&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="window.print();">Imprimer</div>&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="location.reload();">Déconnexion</div>';
  ...
  function displaySub(aTab)
  {
  	//alert(aTab);
        ...
        if (aTab == "patient")
        {
        	...
        	document.getElementById("updateAvail").innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="modAlert();">Alerte médicale</div>&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="modSuivi();">Suivi médical</div>&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="modLabo();">Laboratoires</div>';
        }
        ...
        if (aTab == "antecedents")
        {
        	...
        	if (qANT.files.length > 0)
        	{
        		...
        		document.getElementById("updateAvail").innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div id="bPrec" class="ui axxium tiny disabled button" onclick="backANT();">Précédent</div>&nbsp;&nbsp;'+aDate+'&nbsp;&nbsp;&nbsp;<div id="bSuiv" class="ui axxium tiny disabled button" onclick="forANT();">Suivant</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="createANT();">Nouvel historique médical</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="toggleForce();">Voir toutes les réponses</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="getSign(0,\'ANT\');"><i class="write icon"></i> patient</div>&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="getSign(1,\'ANT\');"><i class="write icon"></i> dentiste</div>';
        ...
        if (aTab == "odontos")
        {
        	...
        	if (qODONS.files.length > 0)
        	{
        		...
        		var omen = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div id="bPrec" class="ui axxium tiny disabled button" onclick="backODO();">Précédent</div>&nbsp;&nbsp;'+aDate+'&nbsp;&nbsp;&nbsp;<div id="bSuiv" class="ui axxium tiny disabled button" onclick="forODO();">Suivant</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="createODO();">Nouvel odontogramme</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="toggleOdon();">';
        		if (showAdult)
        		{
        ...
        if (aTab == "paros")
        {
        	...
        	if (qPARS.files.length > 0)
        	{
        		...
        		var omen = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div id="bPrec" class="ui axxium tiny disabled button" onclick="backPAR();">Précédent</div>&nbsp;&nbsp;'+aDate+'&nbsp;&nbsp;&nbsp;<div id="bSuiv" class="ui axxium tiny disabled button" onclick="forPAR();">Suivant</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="createPAR();">Nouveau diagramme</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="toggleParo();">';
        		if (showAdultP)
        		{
        			omen = omen + "Voir dentition primaire";
        		}
        ...
        if (aTab == "plans")
        {
        	...
        	if (qPLANS.files.length > 0)
        	{
        		...
        		document.getElementById("updateAvail").innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div id="bPrec" class="ui axxium tiny disabled button" onclick="backPLA();">Précédent</div>&nbsp;&nbsp;'+aDate+'&nbsp;&nbsp;&nbsp;<div id="bSuiv" class="ui axxium tiny disabled button" onclick="forPLA();">Suivant</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="createPLA();">Nouveau plan</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="getSign(0,\'PLA\');"><i class="write icon"></i> patient</div>&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="getSign(1,\'PLA\');"><i class="write icon"></i> dentiste</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny disabled button" onclick="sendCal();">Calendrier Vision-R</div>';
        ...
        if (aTab == "ententes")
        {
        	...
        	if (qENTS.files.length > 0)
        	{
        		...
        		document.getElementById("updateAvail").innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div id="bPrec" class="ui axxium tiny disabled button" onclick="backENT();">Précédent</div>&nbsp;&nbsp;'+aDate+'&nbsp;&nbsp;&nbsp;<div id="bSuiv" class="ui axxium tiny disabled button" onclick="forENT();">Suivant</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="createENT();">Nouvelle entente de paiement</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="getSign(0,\'ENT\');"><i class="write icon"></i> patient</div>&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="getSign(1,\'ENT\');"><i class="write icon"></i> dentiste</div>';
        ...
        if (aTab == "traitements")
        {
        	...
        	if (qTRAS.files.length > 0)
        	{
        		...
        		document.getElementById("updateAvail").innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div id="bPrec" class="ui axxium tiny disabled button" onclick="backTRA();">Précédent</div>&nbsp;&nbsp;'+aDate+'&nbsp;&nbsp;&nbsp;<div id="bSuiv" class="ui axxium tiny disabled button" onclick="forTRA();">Suivant</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="createTRA();">Nouveaux traitements</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="getSign(0,\'TRA\');"><i class="write icon"></i> patient</div>&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="getSign(1,\'TRA\');"><i class="write icon"></i> dentiste</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny disabled button">Facturation Vision-R</div>';
        ...
        if (aTab == "ordonnances")
        {
        	...
        	if (qORDS.files.length > 0)
        	{
        		...
        		document.getElementById("updateAvail").innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div id="bPrec" class="ui axxium tiny disabled button" onclick="backORD();">Précédent</div>&nbsp;&nbsp;'+aDate+'&nbsp;&nbsp;&nbsp;<div id="bSuiv" class="ui axxium tiny disabled button" onclick="forORD();">Suivant</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="createORD();">Nouvelle ordonnance</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="printORD();">Ordonnance imprimable</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="getSign(1,\'ORD\');"><i class="write icon"></i> dentiste</div>';
        ...
        if (aTab == "documents")
        {
        	...
        	if (qDOCS.files.length > 0)
        	{
        		...
        		document.getElementById("updateAvail").innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div id="bPrec" class="ui axxium tiny disabled button" onclick="backDOC();">Précédent</div>&nbsp;&nbsp;'+aDate+'&nbsp;&nbsp;&nbsp;<div id="bSuiv" class="ui axxium tiny disabled button" onclick="forDOC();">Suivant</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny disabled button">Nouveau document</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div id="pPage" class="ui axxium tiny button" onclick="prevPage();">Page précédente</div>&nbsp;&nbsp;'+cPage+'&nbsp;&nbsp;&nbsp;<div id="nPage" class="ui axxium tiny button" onclick="nextPage();">Page suivante</div>';
        	...
        	{
        		document.getElementById("updateAvail").innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny disabled button">Nouveau document</div>';
        	}
        }
