      	  				...
      	  				if (qJSON[extID].qType.substring(0,1) == "M" || qJSON[extID].qType.substring(0,1) == "N")
      	  					{
    	  						...
    	  						div = document.createElement("tr");
      	  						...
      	  						if (forceMustSee || aMust == "Y" || (ctrM > 0 && !nominal))
      	  						{
      	  							...
      	  							aLine = aLine + '<td><b>'+chk+'</b></td><td id="n'+extID+'" class="warning">'+qJSON[extID].qEdits+'</td><td><h4><div class="ui axxium tiny button" onclick="addNotes(\''+extID+'\');">Ajouter</div></h4></td>';
      	  							div.innerHTML = aLine;
    	  							document.getElementById("eachAnt").appendChild(div);
      	  						}
      	  					}
      	  				...
      	  				else if (qJSON[extID].qType == "TX")
      	  					{
      	  						...
      	  						if (forceMustSee || aMust == "Y" || ctrT > 0)
      	  						{
    	  							div = document.createElement("tr");
      	  							aLine = '<td>'+extID+'</td><td>'+allJSONs[extID].question[lang]+'</td>';
      	  							aLine = aLine + '<td><b>'+qJSON[extID].answers[0].text+'</b></td><td id="n'+extID+'" class="warning">'+qJSON[extID].qEdits+'</td><td><h4><div class="ui axxium tiny button" onclick="addNotes(\''+extID+'\');">Ajouter</div></h4></td>';
      	  							div.innerHTML = aLine;
    	  							document.getElementById("eachAnt").appendChild(div);
      	  						}
      	  					}
      	  				else
      	  					{
    	  						div = document.createElement("tr");
      	  						aLine = '<td>'+extID+'</td><td>'+allJSONs[extID].question[lang]+'</td>';
      	  						aLine = aLine + '<td></td><td id="n'+extID+'" class="warning">'+qJSON[extID].qEdits+'</td><td><h4><div class="ui axxium tiny button" onclick="addNotes(\''+extID+'\');">Ajouter</div></h4></td>';
      	  						div.innerHTML = aLine;
    	  						document.getElementById("eachAnt").appendChild(div);
      	  					}
  }
