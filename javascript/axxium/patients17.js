  	...
  	//alert(aTab);
        ...
        if (aTab == "odontos")
        {
        	...
        	if (qODONS.files.length > 0)
        	{
        		...
        		var omen = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="createODO();">Nouvel odontogramme</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div id="bPrec" class="ui axxium tiny disabled button" onclick="backODO();">Précédent</div>&nbsp;&nbsp;'+aDate+'&nbsp;&nbsp;&nbsp;<div id="bSuiv" class="ui axxium tiny disabled button" onclick="forODO();">Suivant</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="ui axxium tiny button" onclick="toggleOdon();">';
        		if (showAdult)
        		{
        ...
        if (aTab == "documents")
        {
        	...
        	if (qDOCS.files.length > 0)
        	{
        		...
        		document.getElementById("updateAvail").innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>Ajouter un document: <input type="file" accept="application/pdf" id="docCapture" onchange="uploadDoc()"></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div id="bPrec" class="ui axxium tiny disabled button" onclick="backDOC();">Précédent</div>&nbsp;&nbsp;'+aDate+'&nbsp;&nbsp;&nbsp;<div id="bSuiv" class="ui axxium tiny disabled button" onclick="forDOC();">Suivant</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div id="pPage" class="ui axxium tiny button" onclick="prevPage();">Page précédente</div>&nbsp;&nbsp;'+cPage+'&nbsp;&nbsp;&nbsp;<div id="nPage" class="ui axxium tiny button" onclick="nextPage();">Page suivante</div>';
        	...
        	{
        		document.getElementById("updateAvail").innerHTML = '<form id="myForm">Document :<input type="file" name="file"><input type="submit" value="Envoyer"></form>';
			...
			form.onsubmit = function() {
			  ...
			  formData.append("tx", "uploadDOC");
			  formData.append("patID", curPatient);
